...
public sealed class File : Table {
  ...
  public Versions Version { get { int o = __offset(4); return o != 0 ? (Versions)bb.GetInt(o + bb_pos) : Versions.V0; } }
  public ExecutableUnit GetRows(int j) { return GetRows(new ExecutableUnit(), j); }
  public ExecutableUnit GetRows(ExecutableUnit obj, int j) { int o = __offset(6); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
