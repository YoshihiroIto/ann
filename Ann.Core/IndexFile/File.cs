...
public sealed class File : Table {
  ...
  public ExecutableUnit GetRows(int j) { return GetRows(new ExecutableUnit(), j); }
  public ExecutableUnit GetRows(ExecutableUnit obj, int j) { int o = __offset(4); return o != 0 ? obj.__init(__indirect(__vector(o) + j * 4), bb) : null; }
  public int RowsLength { get { int o = __offset(4); return o != 0 ? __vector_len(o) : 0; } }
  ...
  public static void StartFile(FlatBufferBuilder builder) { builder.StartObject(1); }
  public static void AddRows(FlatBufferBuilder builder, VectorOffset RowsOffset) { builder.AddOffset(0, RowsOffset.Value, 0); }
  public static VectorOffset CreateRowsVector(FlatBufferBuilder builder, Offset<ExecutableUnit>[] data) { builder.StartVector(4, data.Length, 4); for (int i = data.Length - 1; i >= 0; i--) builder.AddOffset(data[i].Value); return builder.EndVector(); }
